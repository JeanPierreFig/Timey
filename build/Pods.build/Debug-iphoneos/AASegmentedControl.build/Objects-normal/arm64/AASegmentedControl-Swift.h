...
SWIFT_MODULE_NAMESPACE_PUSH("AASegmentedControl")
@class UIColor;
@class UITouch;
@class UIEvent;
@class NSCoder;

SWIFT_CLASS("_TtC18AASegmentedControl18AASegmentedControl")
@interface AASegmentedControl : UIControl
/// @IBInspectable Allow daming animation
@property (nonatomic) BOOL allowDamping;
/// @IBInspectable Active underline bool
@property (nonatomic) BOOL activeUnderline;
...
@property (nonatomic, strong) UIColor * _Nonnull unactiveColor;
/// @IBInspectable active background color
@property (nonatomic, strong) UIColor * _Nonnull activeBG;
/// draw
/// \param rect rect
///
